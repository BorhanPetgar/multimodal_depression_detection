...
df = pd.read_csv('/home/borhan/Desktop/multimodal_depression_detection/data/test/text/text_image_prob_merged.csv')
...
print(f'accuracy: {calculate_accuracy(w1=0.412)}')